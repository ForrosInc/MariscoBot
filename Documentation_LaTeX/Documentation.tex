...
\noindent\framebox[1.1\width]{Summon Marisco} : Undocumented magic fuckery\footnote{Someone should really verify the channel is bound before sending a message}\newline
\noindent\framebox[1.1\width]{M-play \$x} : Search \$x on youtube and play the first result\newline
\noindent\framebox[1.1\width]{Danbooru:\$x} : Search for \$x tag on Danbooru \textbf{\emph{WARNING: NSFW}}\par
\end{flushleft}
